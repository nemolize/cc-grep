...
cannot separate from a real edit. The match is on the call rather than its
outcome, so an edit that failed still matches; the attempt is itself evidence
that session was working on the file.
